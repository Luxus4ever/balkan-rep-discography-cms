...
//Stranica koja prikazuje izabrani album za ADMINA i MODERATORA. Razlika je u tome što u url adresi ima samo $idAlb
        ...
        }else
            {
                ...
                <div class="col-md-10 panel">
                    ...
                    if(($sesStatusK==1) || ($sesStatusK==2) || (!empty($userAdmin)===$sesId))
                    {
                        ...
                        {
                            case "0"; zabranjenPristup($sesStatusK); break; //blokiran
                            case 1; adminIzabraniSingleAlbum($idAlb); break; //admin
                            case 2; adminIzabraniSingleAlbum($idAlb); break; //moderator
